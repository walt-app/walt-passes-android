...
class PdfThumbnailSurfaceTest {
    ...
    fun rememberPdfThumbnailReturnsPdfThumbnailState() {
        val method = findTopLevel("PdfThumbnailKt", "rememberPdfThumbnail")
        assertThat(method.returnType.name).isEqualTo("is.walt.passes.document.ui.PdfThumbnailState")
    }
    ...
    fun pdfThumbnailStateHasExactlyThreePermittedSubclasses() {
        ...
        val sealed = Class.forName("is.walt.passes.document.ui.PdfThumbnailState")
    ...
    fun pdfThumbnailStateRenderedExposesOnlyImageAndPageAspect() {
        ...
        val rendered = Class.forName("is.walt.passes.document.ui.PdfThumbnailState\$Rendered")
    ...
    fun pdfThumbnailStateFailedKindIsDocumentRejectedKind() {
        ...
        val failed = Class.forName("is.walt.passes.document.ui.PdfThumbnailState\$Failed")
    ...
    fun pdfThumbnailCachePublicSurfaceIsConstructorAndClear() {
        ...
        val klass = Class.forName("is.walt.passes.document.ui.PdfThumbnailCache")
    ...
    fun newPublicTypesHaveNoExtractionShapedAccessors() {
        ...
        val classesToScan = listOf(
            "is.walt.passes.document.ui.PdfThumbnailKt",
            "is.walt.passes.document.ui.PdfThumbnailState",
            "is.walt.passes.document.ui.PdfThumbnailState\$Loading",
            "is.walt.passes.document.ui.PdfThumbnailState\$Rendered",
            "is.walt.passes.document.ui.PdfThumbnailState\$Failed",
            "is.walt.passes.document.ui.PdfThumbnailCache",
        )
