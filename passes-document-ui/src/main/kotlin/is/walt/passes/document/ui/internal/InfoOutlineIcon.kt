...
/**
 * Hand-authored "info outline" glyph used by [is.walt.passes.document.ui.DocumentTrustCaption].
 *
 * Kept in-module on purpose: `passes-document-ui` does NOT depend on
